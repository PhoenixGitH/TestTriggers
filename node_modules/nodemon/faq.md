...
Note that I *would not* recommend using nodemon in a APIion environment - but that's because I wouldn't want it restart without my explicit instruction.
